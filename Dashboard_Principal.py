...
# ==============================================================================
    ...
    # Encontrar periodo previo para análisis comparativo
    ...
    with tab_gen:
        ...
        with st.expander("🧠 **Ver Análisis y Consejos del CFO Virtual (IA)**", expanded=True):
             with st.spinner('El CFO Virtual está preparando un análisis profundo...'):
                ...
                analisis_ia = generar_analisis_avanzado_ia(contexto_ia) # Pasamos el nuevo contexto enriquecido
    ...
    st.sidebar.markdown("---")
    er_to_dl = generate_financial_statement(df_er_actual, 'Estado de Resultados', cc_filter, 99) # Descarga siempre el máximo detalle
